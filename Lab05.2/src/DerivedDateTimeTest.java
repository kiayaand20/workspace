...
class DerivedDateTimeTest {
    ...
    public static void testPresidentsFirst100Days() {
        ...
        LocalDate date100 = inaugurationDay.plusDays(100);
    ...
    public static void testPopularBirthdays() {
        ...
        LocalDate valentineBirthday = LocalDate.of(1990, 02, 14);
        LocalDate conceiveDate = valentineBirthday.plusWeeks(38);
        System.out.println(conceiveDate);

        // TODO: what is the average birthday of someone conceived on New Year's Eve (after midnight)?
        LocalDateTime conceivedOnNewYearsEve = LocalDateTime.of(1990, 01, 01, 00, 00);
        LocalDateTime averageBirthday = conceivedOnNewYearsEve.plusWeeks(38);
        System.out.println(averageBirthday);
    }
