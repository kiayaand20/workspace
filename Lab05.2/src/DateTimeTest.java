...
class DateTimeTest {
    ...
    public static void testCreate() {
        ...
        LocalDate bday = LocalDate.of(1989, Month.MARCH, 19);
        ...
        LocalDateTime firstLunarLanding = LocalDateTime.of(1969, Month.JULY, 20, 3, 18);
    ...
    public static void testParse() {
        ...
        LocalDate bday = LocalDate.parse("1989-03-19");
    ...
    public static void testFormat() {
        ...
        String display3 = hastings.format(DateTimeFormatter.ofPattern("MMM dd, yyyy"));
